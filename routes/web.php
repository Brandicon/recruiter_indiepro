...
Route::group(
    ['namespace' => 'SaasFront'],
    function () {
        Route::get('/', 'SaasFrontController@index')->name('index')->Middleware('disable-frontend');
        ...
        function () {
            Route::group(['middleware' => ['active-package']], function () {
                ...
                Route::group(
                    ['prefix' => 'settings'],
                    function () {
                        Route::get('/sandbox-dashboard', ['as' => 'settings.sandbox.dashboard', 'uses' => 'CompanySettingsController@sandboxdashboard']);
...
//                        Route::post('settings/delete-account-cancel', ['as' => 'settings.delete-account-cancel', 'uses' => 'ApplicationSettingsController@deleteAccountStore']);
                        ...
                        Route::post('theme-settings/rtlTheme', ['uses' => 'AdminThemeSettingsController@rtlTheme'])->name('theme-settings.rtlTheme');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('theme-settings/disable-frontend', ['uses' => 'SuperAdminThemeSettingsController@disableFrontend'])->name('theme-settings.disableFrontend');
            ...
            Route::resource('signup-setting', 'SuperAdminSignupSettingsController');
            ...
            Route::get('front-cms/common', ['as' => 'front-cms.common', 'uses' => 'SuperAdminFrontCmsController@commonSetting']);
