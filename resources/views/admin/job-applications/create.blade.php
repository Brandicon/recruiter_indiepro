                            ...
                            <p>You do not have any job created. You need to create the job first to add the job
                                ...
                                <a href="{{ route('admin.jobs.create') }}" class="btn btn-info btn-sm m-l-15"
                                   style="text-decoration: none;"><i
                                            class="fa fa-plus-circle"></i> @lang('app.createNew') @lang('menu.jobs')</a>
                            </p>
                        </div>
                    @else
                        ...
                        <form class="ajax-form" method="POST" id="createForm">
                            ...
                            <div class="row">
                                <div class="col-md-12 pl-4 pr-4 pt-4 b-b ">
                                    <div class="col-md-12 form-group">
                                        <label class="">
                                            <div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false" style="position: relative;">
                                                <input type="checkbox" value="1" name="send_mail"  class="iCheck-helper" id ="send_mail"  style="position: absolute; opacity: 0;">
