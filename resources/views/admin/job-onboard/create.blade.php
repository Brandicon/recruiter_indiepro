...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepicker" date-format="yyyy-m-d" name="last_date" id="last_date" autocomplete ="off" value="">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
    ...
    <div class="modal fade bs-modal-md in" id="addDepartmentModal" role="dialog" style ="margin-left: 220px;" aria-labelledby="myModalLabel"
         aria-hidden="true">
