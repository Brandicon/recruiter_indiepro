        ...
        <table class="table">
            ...
            @forelse($designations as $key=>$designation)
                <tr id="desig-{{ $designation->id }}">
                    ...
                    <td>
                        <a href="javascript:;" data-dept-id="{{ $designation->id }}" class="btn btn-sm btn-danger btn-rounded delete-designation"><i class="fa fa-times" data-toggle="tooltip" data-original-title="Delete"></i></a>
                        <a href="javascript:;" data-dept-id="{{ $designation->id }}" class="btn btn-sm btn-info btn-rounded edit-designation" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i> </a>
                    </td>
                </tr>
            @empty
                <tr>
