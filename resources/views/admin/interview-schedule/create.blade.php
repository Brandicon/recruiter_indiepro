            ...
            <div class="row">
                <div class="col-md-6  col-xs-12">
                    <div class="form-group">
                        <label class="d-block required">@lang('modules.interviewSchedule.candidate')</label>
                        <select class="select2 m-b-10 form-control select2-multiple" multiple="multiple"
                                data-placeholder="@lang('modules.interviewSchedule.chooseCandidate')" name="candidates[]">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        <label class="d-block required">@lang('modules.interviewSchedule.employee')</label>
                        <select class="select2 m-b-10 form-control select2-multiple " multiple="multiple"
            ...
            <div class="row">
                ...
                <div class="col-xs-5 col-md-3">
                    <div class="form-group chooseCandidate bootstrap-timepicker timepicker">
                        <label class="required">@lang('modules.interviewSchedule.scheduleTime')</label>
                ...
                <div class="col-xs-6 col-md-3 ">
                    <div class="form-group" id="end_date_section" style="display: none">
                        <label class="required">@lang('modules.interviewSchedule.endDate')</label>
                        <input type="text" name="end_date" id="end_date" value="{{$scheduleDate}}" class="form-control">
                    </div>
                </div>
