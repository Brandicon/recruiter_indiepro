    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            @if(!is_null($activePackage))
                    ...
                    <ul class="nav nav-treeview">
                        @if(!is_null($activePackage))
                            ...
                            @if(in_array("manage_settings", $userPermissions))
                                ...
                                @endif
                                <li class="nav-item">
                                    <a href="{{ route('admin.zoom-setting.index') }}" class="nav-link {{ request()->is('admin/settings/zoom-setting') ? 'active' : '' }}">
                                        <i class="fa fa-circle-o nav-icon"></i>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.settings.sandbox.dashboard',['dashboard']) }}" class="nav-link">
                        <i class="fa fa-cube nav-icon"></i>
                        <p> @lang('menu.sandboxDash')</p>
                    </a>
                </li>
