        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="editSettings" class="ajax-form">
                        ...
                        <div class="form-group trial">
                            <label class="make_private">
                                <div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false" style="position: relative;">
                                    <input  type="checkbox" @if($package->is_private == 1) checked @endif  value="1" name="is_private" id="is_private" class="flat-red"  style="position: absolute; opacity: 0;">
                    ...
                    <button type="reset" onclick="resetForm();" class="btn btn-inverse waves-effect waves-light reset-button">@lang('app.reset')</button>
                </form>
            </div>
        </div>
    </div>
