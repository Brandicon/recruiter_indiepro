            ...
            <div class="card-body">
                ...
                <form id="editSettings" class="ajax-form">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class= "required" for="company_name">@lang('modules.packages.packageName')</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label  class= "required"  for="company_phone">@lang('modules.packages.monthlyPrice')</label>
                                <input type="text" class="form-control" id="monthly_price" name="monthly_price">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label  class= "required" for="company_phone">@lang('modules.packages.annualPrice')</label>
