                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="switchery-demo">
                                    ...
                                    data-secondary-color="#f96262" value="1" @if($global->disable_frontend == 1) checked
                                    @endif />
                                </div>
                             </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-group">
                                   <label
                                       class="control-label">@lang('app.setHomePage')
                                    </label>
                                   <div class="switchery-demo">
                                       <input type="checkbox" name="setup_homepage"
                                        class="js-switch" id="setup_homepage" data-color="#00c292"
                                       data-secondary-color="#f96262" value="1" @if($global->setup_homepage == 1) checked
                                       @endif />
                                   </div>
                                </div>
                                <div id="custom_url">
                                <label for="">@lang('menu.customUrl')</label>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="{{ $global->custom_homepage_url }}" name="custom_homepage_url" id="custom_homepage_url" placeholder="@lang('app.customUrlExammple')">
                                                </div>
                                            </div>
                               </div>
...
<script src="{{ asset('assets/node_modules/switchery/dist/switchery.min.js') }}"></script>
    ...
    $('.disable').change(function () {
        ...
        $.easyAjax({
            url: '{{route('superadmin.theme-settings.disableFrontend')}}',
            type: "POST",
...
$(function(){
    ...
    $('#setup_homepage').change(function () {
        let custom = $(this).is(':checked') ? 1 : 0; 
        if (custom == 1) {
            $("#custom_url").show()
        } 
        else{
