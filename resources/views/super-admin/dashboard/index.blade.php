...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12">
            @if(!is_null($packageData) && $paymentSetting->stripe_status == 'active')
                ...
                <div class="alert alert-danger col-md-12">
                    <div class="col-md-12"><b><i class="ti-info"></i>@lang('app.setPlanID'): </b> @lang('messages.PlanIdRequired') <a    href="{{ route('superadmin.packages.index') }}">  <button class="btn btn-warning btn-sm ">@lang('menu.packages')</button></a>
                    </div>
                </div>
            @endif
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xlg-2">
            <a href="{{ route('superadmin.company.index') }}" target="_blank">
                <div class="card">
        ...
        <div class="col-md-6 col-lg-4 col-xlg-2">
            <a href="{{ route('superadmin.company.index',['status'=>'active']) }}" target="_blank">
            <div class="card">
        ...
        <div class="col-md-6 col-lg-4 col-xlg-2">
            <a href="{{ route('superadmin.company.index',['status'=>'inactive']) }}" target="_blank">
            <div class="card">
        ...
        <div class="col-md-6 col-lg-4 col-xlg-2">
            <a href="{{ route('superadmin.packages.index',['status'=>'inactive']) }}" target="_blank">
            <div class="card">
        ...
        <div class="col-md-6 col-lg-4 col-xlg-2">
            <a href="{{ route('superadmin.company.index',['status'=>'front_pending']) }}" target="_blank">
            <div class="card">
