                ...
                <div class="card-body">
                    ...
                    <form id="editPaymentSettings" class="ajax-form">
                        ...
                        <div id="paypal-credentials">
                            <div class="form-group" >
                                <label class ="required" for="mail_username">@lang('app.clientid')</label>
                            ...
                            <div class="form-group"  id="paypal_secret_box">
                                <label class ="required" for="mail_password">@lang('app.secret')</label>
                        ...
                        <div id="stripe-credentials">
                            <div class="form-group">
                                <label class ="required" for="api_key">Publishable Key</label>
                            ...
                            <div class="form-group">
                                <label class ="required" for="webhook_key">@lang('app.webhook')</label>
                        ...
                        <hr>
                            ...
                            <div id="razorpay-credentials" @if($credentials->razorpay_status != 'active') class="box-display" @endif>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class ="required">Razorpay Key</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class ="required">@lang('app.razorSecret')</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class ="required">@lang('app.razorWebhook')</label>
