        ...
        <div class="main-container">
            <section class="imageblock switchable feature-large height-100">
                ...
                <div class="container pos-vertical-center">
                    <div class="row">
                        @if($registration->registration_open == 1)
                        <div class="col-lg-7 col-md-7">
                            ...
                            <p class="lead">@lang('modules.register.subHeading')
                                {{$packages->trial_duration}} @lang('modules.register.subHeadingNew')
                            </p>
                        ...
                        <div class="login-box mt-5 form-section register-message">
                            <h4 class="mb-0 text-center text-design">
                                {{$registration->registraion_message}}
                            </h4>
                        </div>
                        @endif
                    </div>
