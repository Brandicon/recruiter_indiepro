...
@section('content')
                    ...
                    <div class="slider slider--inline-arrows slider--arrows-hover text-center" data-arrows="true">
                        <ul class="slides">
                            ...
                            <li class="col-md-3 col-6">
                                @php
                                $slug = $featuredCompany->career_page_link;
                                    if(module_enabled('Subdomain'))
                                    {
                                        $slug = $featuredCompany->sub_domain;
                                    }
                                @endphp
                                <a href="{{ frontJobOpenings($slug) }}" target="_blank">
    ...
    <section class="text-center text-white bg_custom">
        <div class="container">
            <div class="row">
    ...
    <!--    </div>-->
    <!--</section>-->
    <section class="switchable mt-4" id="contact">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-5">
