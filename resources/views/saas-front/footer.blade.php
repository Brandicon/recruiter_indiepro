                    ...
                    <div class="widget widget-links">
                        ...
                        <ul class="list-no-dividers">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                        <a class="nav-link" href="https://www.indiepro.io/landing">@lang('menu.home')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="@if(\Request()->is('/')) #header-section @else {{ route('index') }} @endif">Recruiter</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="https://www.indiepro.io/">Indiepro Features</a>
                                    </li>
                                <li class="nav-item">
