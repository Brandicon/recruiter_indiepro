                        ...
                        <div class="col-lg-11 col-md-12 text-right text-left-xs text-left-sm">
                            <div class="bar__module">
                                <ul class="menu-horizontal text-left">
                                    <li class="dropdown">
                                        <a class="inner-link" href="https://www.indiepro.io/landing">@lang('menu.home')</a>
                                    </li>
                                    <li class="dropdown">
                                        <a class="inner-link" href="@if(\Request()->is('/')) #header-section @else {{ route('index') }} @endif">Recruiter</a>
                                    </li>
                                    <li class="dropdown">
                                        <a class="inner-link" href="https://www.indiepro.io/">Indiepro Features</a>
                                    </li>
                                    <!--<li class="dropdown">-->
                            ...
                            <div class="bar__module">
                                ...
                                @if($firstHeaderData->show_register_in_menu && $global->registration_disable_button == true)
