        ...
        return DataTables::of($paypal)
            ...
            ->addColumn('action', function ($row) {
                if($row->method == 'Stripe' && $row->invoice_id){
                    return '<a href="'.route('superadmin.invoices.invoice-download', $row->invoice_id).'" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" onclick="this.blur()" data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
                if($row->method == 'Paypal'){
                    return '<a href="'.route('superadmin.invoices.paypal-invoice-download', $row->id).'" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip"  onclick="this.blur()" data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
                if($row->method == 'Razorpay'){
                    return '<a href="'.route('superadmin.invoices.razorpay-invoice-download', $row->id).'" class="btn btn-info btn-circle waves-effect" data-toggle="tooltip" onclick="this.blur()"  data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
