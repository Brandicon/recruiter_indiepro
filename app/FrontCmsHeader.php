...
class FrontCmsHeader extends Model
{
    ...
    public function getLogoUrlAttribute()
    {
        ...
        return asset_url_local_s3('front-logo/' . $this->logo);
    }
    ...
    public function getHeaderImageUrlAttribute()
    {
        ...
        return asset_url_local_s3('header-image/' . $this->header_image);
    }
    ...
    public function getHeaderBackroundImageUrlAttribute()
    {
        ...
        return asset_url_local_s3('header-background-image/' . $this->header_backround_image);
    }
    public function getLoginBackgroundImageUrlAttribute()
    {
        ...
        return asset_url_local_s3('login-background-image/' . $this->login_background);
    }
    ...
    public function getRegisterBackgroundImageUrlAttribute()
    {
        ...
        return asset_url_local_s3('register-background-image/' . $this->register_background);
    }
}
