...
class LanguageSettingsController extends SuperAdminBaseController
{
    ...
    {
        return view('super-admin.language-settings.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('super-admin.language-settings.edit', compact('language'));
    }
