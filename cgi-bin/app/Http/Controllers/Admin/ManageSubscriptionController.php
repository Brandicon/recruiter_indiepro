        ...
        return DataTables::of($paypalData)
            ...
            ->addColumn('action', function ($row) {
                if($row->method == 'Stripe'){
                    return '<a href="'.route('admin.subscribe.invoice-download', $row->invoice_id).'" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" onclick="this.blur()" data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
                if($row->method == 'Paypal'){
                    return '<a href="'.route('admin.subscribe.paypal-invoice-download', $row->id).'" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" onclick="this.blur()" data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
...
//                  $subscriptions = $api->subscription->all();
    ...
    public function historyData()
    {
        $packages = CompanyPackage::select('company_packages.id','packages.name','company_packages.package_type',
            ...
            'company_packages.stripe_id','stripe_invoices.invoice_id', 'company_packages.paypal_id','packages.monthly_price','packages.annual_price')
        ...
        return DataTables::of($packages)
            ...
            ->addColumn('payment_method', function ($row) {
                ...
                else if($row->monthly_price == '0.0' && $row->annual_price == '0.0'){
                    return '--';
                }
                else{
                    return 'Cash';
            ...
            ->addColumn('action', function ($row) {
                ...
                if($row->stripe_id != null){
                    $string .= '<a href="'.route('admin.subscribe.invoice-download', $row->invoice_id).'" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" onclick="this.blur()" data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
               else if($row->paypal_id != null){
                   $string .= '<a href="'.route('admin.subscribe.paypal-invoice-download', $row->paypal_id).'" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" onclick="this.blur()" data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
                else{
                    $string .= '<a href="'.route('admin.subscribe.default-invoice-download', $row->id).'" class="btn btn-primary btn-circle waves-effect" data-toggle="tooltip" onclick="this.blur()" data-original-title="Download"><span></span> <i class="fa fa-download"></i></a>';
                }
                 return   $string;
